...
function AdditionalServices() {
    return (
        <>
            ...
            <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-[30px] px-4'>
                    <div
                    ...
                    >
                      ...
                      <h2 className='md:text-lg text-sm font-semibold text-[#37322C] flex gap-2'><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg> وجبات يومية في الفندق</h2>

                      <div className='flex flex-col flex-wrap'>
                      <h2 className='md:text-md text-sm text-[#C09C78] text-center'> السعر: <span className='font-[500] md:text-lg'>60</span> ريال / يوم</h2>
                      <button className='bg-[#AE7639] text-sm font-semibold text-white md:px-12 px-0 py-2 m-2 rounded'>أضف الخدمة</button>
...
</svg> خدمة الاستقبال والتوصيل</h2>

                      <div className='flex flex-col flex-wrap'>
                      <h2 className='md:text-md text-sm text-[#C09C78] text-center'> السعر: <span className='font-[500] md:text-lg'>100</span> ريال / يوم</h2>
                      <button className='bg-[#AE7639] text-sm font-semibold text-white md:px-12 px-0 py-2 m-2 rounded'>أضف الخدمة</button>
...
</svg>  باقة راحة المعتمر</h2>

                      <div className='flex flex-col flex-wrap'>
                      <h2 className='md:text-md text-sm text-[#C09C78] text-center'> السعر: <span className='font-[500] md:text-lg'>20</span> ريال / يوم</h2>
                      <button className='bg-[#AE7639] text-sm font-semibold text-white md:px-12 px-0 py-2 m-2 rounded'>أضف الخدمة</button>
