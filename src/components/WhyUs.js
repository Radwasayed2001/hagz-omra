...
function WhyUs() {
    const features = [
        ...
        
        {
            ...
            icon: <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M29.8327 15.9998C29.8327 8.63604 23.8631 2.6665 16.4993 2.6665C9.13555 2.6665 3.16602 8.63604 3.16602 15.9998C3.16602 23.3636 9.13555 29.3332 16.4993 29.3332C23.8631 29.3332 29.8327 23.3636 29.8327 15.9998Z" stroke="#F8FAFB" stroke-width="2"/>
            <path d="M11.166 16.6667L14.4993 20L21.8327 12" stroke="#F8FAFB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>,
          },
      ];
  return (
